...
# ==========================================
# VISTA 1: TRABAJOS Y PEDIDOS (CONFIGURACIÓN CLÁSICA CON PANELES ARRIBA)
# ==========================================
if st.session_state.seccion_activa == "Trabajos":
    ...
    # 2. PANELES SUPERIORES: MODIFICAR, DEVOLVER Y BORRAR
    ...
    # 4. FILTROS, ORDENAMIENTO Y TABLA NATIVA ORIGINAL (FOTO 2)
    if not df_todos_trabajos.empty:
